...
import { listTitleChanged, listItemAdded, listItemMarked } from '../../store/actionCreators'
...
export default function TodoList({id}) {
  ...
  */
  ...
  useEffect(() => !listData.title && setChangeTitleMode(true), [listData.title])

  const handleAddButton = () => !changeTitleMode && setAddTaskMode(true)
  const handleChangeTitleButton = () => !addTaskMode && setChangeTitleMode(true)
